...
const Footer = () => {
  return (
    <footer className="bg-white text-slate-700 dark:bg-slate-950 dark:text-white">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <img
              ...
              className="h-12 w-12 rounded-full dark:hidden"
            />
            <img
              src={logoDark}
              alt="Elivate ICT Solutions logo"
              className="hidden h-12 w-12 rounded-full dark:block"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            {[Facebook, Instagram, Linkedin, Twitter].map((Icon, index) => (
              <span
                key={index}
                className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500 dark:border-white/10 dark:bg-white/5 dark:text-slate-200"
              >
                <Icon size={16} />
              </span>
            ))}
      ...
      <div className="border-t border-slate-200 py-6 text-center text-xs text-slate-500 dark:border-white/10">
